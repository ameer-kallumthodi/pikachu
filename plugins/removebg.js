...
if (Config.WORKTYPE == 'private') {
    ...
    Asena.addCommand({pattern: 'removebg ?(.*)', fromMe: true, desc: Lang.REMOVEBG_DESC}, (async (message, match) => {    
        ...
        await message.client.sendMessage(message.jid,fs.readFileSync('rbg.png'), MessageType.document, {filename: 'ᴘʀɪɴᴄᴇ ʀᴜᴅʜ.png', mimetype: Mimetype.png});
        await load.delete();
    }));
}
    ...
    Asena.addCommand({pattern: 'removebg ?(.*)', fromMe: false, desc: Lang.REMOVEBG_DESC}, (async (message, match) => {    
        ...
        await message.client.sendMessage(message.jid,fs.readFileSync('rbg.png'), MessageType.document, {filename: 'RDX BOT.png', mimetype: Mimetype.png});
        await load.delete();
    }));
