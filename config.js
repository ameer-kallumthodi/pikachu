...
module.exports = {
    ...
    ALL: process.env.ALL_CAPTION === undefined ? 'Made by Ameer Suhail' : process.env.ALL_CAPTION,
    ...
    BOTNAME: process.env.BOT_NAME === undefined ? '  Pikachu  \n\n   *ωнαтsαρρ вσт™*   \n' : process.env.BOT_NAME,
    NOLOG: process.env.NO_LOG === undefined ? 'false' : process.env.NO_LOG,
    THERI_KICK: process.env.THERI_KICK === undefined ? 'false' : process.env.THERI_KICK,
    SONGD: process.env.SONGD === undefined ? '✮⃝🎸Pikachu Downloading Your Song🎧' : process.env.SONGD,
    SONGU: process.env.SONGU === undefined ? '✮⃝🎸Pikachu Downloading Your Song🎧' : process.env.SONGU,
    ...
    LOGO_NAME: process.env.LOGO_NAME === undefined ? 'Pikachu' : process.env.LOGO_NAME,
